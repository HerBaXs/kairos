...
<?php $this->load->view('admin/includes/nav'); ?>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="<?php echo base_url('Nav_Upload_act/'.$nav_up_edit['id']); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Name</label>
                          <input type="text" name="title_button" class="form-control" id="basic-default-fullname" value="<?php echo $nav_up_edit['title_button']; ?>"/>
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="user_file" type="file" id="formFileMultiple" multiple />
                              ...
                              <?php if($nav_up_edit['file']){ ?>
                                  <img style="width: 200px; height: 55px; object-fit: cover;" src="<?php echo base_url('uploads/admin/nav/'.$nav_up_edit['file']); ?>">
                              <?php }else{ ?>

...
<?php $this->load->view('admin/includes/nav'); ?>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="<?php echo base_url('About_Edit_Act/'.$about_edit['id']); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Title</label>
                          <input type="text" name="title" class="form-control" id="basic-default-fullname" maxlength="90" value="<?php echo $about_edit['title']; ?>"/>
                        </div>
                        <div class="mb-3">

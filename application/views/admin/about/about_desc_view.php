...
<?php $this->load->view('admin/includes/nav'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col">
                    <div class="card mb-4">
                        <h5 class="card-header">About View</h5>
                        <a style="text-align: right; padding-right: 5px;" href="<?php echo base_url('About'); ?>">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                <p class="mb-0"><?php echo $about_view['title']; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td class="align-middle"><small class="text-light fw-semibold">Description</small></td>
                                <td class="py-3">
                                <p class="mb-0"><?php echo $about_view['descon']; ?></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>

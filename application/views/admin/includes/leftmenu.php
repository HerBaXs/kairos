...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?php echo base_url('Nav'); ?>" class="menu-link">
              <i class='bx bxs-dock-top'></i>
                <div data-i18n="Basic">Nav</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              ...
              <i class='bx bx-home-alt'></i>
                <div data-i18n="Basic" style="padding-top: 5px;">Home</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?php echo base_url('About'); ?>" class="menu-link">
              <i class='bx bx-book'></i>
                <div data-i18n="Basic" style="padding-top: 5px;">About</div>
              </a>
            </li>
